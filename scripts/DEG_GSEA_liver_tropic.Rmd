---
title: "GO and KEGG Term Enrichment of DE Genes Between DepMap Primary Melanoma and MetMap Liver Tropic Samples"
author: "Theo Killian"
date: "`r Sys.Date()`"
output:
  html_document:
...
# set project name
project_name <- "metmap_liver_tropic"
...
readRDS("./data/depmap_melanoma_limma_metmap_2025-06-13.rds")[[1]] %>%
  dplyr::filter(
    !is.na(gene_name),
    !is.na(entrez_id),
